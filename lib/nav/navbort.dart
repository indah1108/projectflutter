...
void main() => runApp(const nvbort());

class nvbort extends StatelessWidget {
  const nvbort({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color.fromARGB(255, 203, 140, 245), // Warna tab aktif
        unselectedItemColor: const Color.fromARGB(255, 248, 201, 140), // Warna tab tidak aktif
