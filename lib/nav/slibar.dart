...
void main() => runApp(const slbr());

class slbr extends StatelessWidget {
  const slbr({super.key});
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverAppBar(
            ...
            backgroundColor: const Color.fromARGB(255, 236, 122, 160), // Warna latar belakang AppBar
